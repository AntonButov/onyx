...
export const S = {
  ...
  auth: {
    ...
    logIn: "Войти",
    completeSignupCloud: "Завершите регистрацию",
    createAccountHeading: "Создать учётную запись",
    getStartedWith: "Начните работу с",
    orDivider: "или",
    joiningProgress: "Присоединение...",
    creatingAccountProgress: "Создание учётной записи...",
    signingInProgress: "Вход...",
    accountCreatedSigningIn: "Учётная запись создана. Выполняется вход...",
    signedInSuccessfully: "Вход выполнен успешно.",
    passwordMinLengthTemplate: "Пароль должен содержать не менее {min} символов",
    signupFailedPrefix: "Не удалось зарегистрироваться",
    loginFailedPrefix: "Не удалось войти",
    accountAlreadyExists: "Учётная запись с указанным email уже существует.",
    tooManyRequests: "Слишком много запросов. Попробуйте позже.",
    accountCreatedToast: "Учётная запись создана успешно. Войдите.",
    createAccountToSetPassword: "Создайте учётную запись, чтобы задать пароль",
    unknownError: "Неизвестная ошибка",
    emailAddressLabel: "Адрес email",
    emailPlaceholder: "email@вашакомпания.com",
    continueAsGuest: "или продолжить как гость",
    joinButton: "Присоединиться",
    emailVerifiedSignIn: "Email подтверждён! Войдите, чтобы продолжить.",
    noAccount: "Нет учётной записи?",
    createAccountLink: "Создать учётную запись",
    resetPasswordButton: "Сбросить пароль",
    continueWithGoogle: "Продолжить с Google",
    continueWithOidc: "Продолжить с OIDC SSO",
    continueWithSaml: "Продолжить с SAML SSO",
    needAccessItAdmin:
      "Нужен доступ? Обратитесь к администратору ИТ в вашей организации.",
    referralHowHear: "Как вы узнали о нас?",
    referralSelectPlaceholder: "Выберите вариант",
    referralSearchEngine: "Поисковая система (Google/Bing)",
    referralFriend: "Знакомый / коллега",
    referralLinkedin: "LinkedIn",
    referralTwitter: "Twitter",
    referralHackernews: "Hacker News",
    referralReddit: "Reddit",
    referralYoutube: "YouTube",
    referralPodcast: "Подкаст",
    referralBlog: "Статья / блог",
    referralAds: "Реклама",
