    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            title="Default Model"
            description="This model will be used by Cleardocs by default in your chats."
          >
            <LLMPopover
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            ...
            description="Let Cleardocs reference stored memories in chats."
          >
            <Switch
          ...
          <InputLayouts.Horizontal
            ...
            description="Let Cleardocs generate and update stored memories."
          >
            <Switch
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              ...
              lose access to Cleardocs. This action cannot be undone.
            </Text>
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              Cleardocs will no longer be able to access or search content from your{" "}
