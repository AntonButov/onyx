  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to Cleardocs has been temporarily suspended due to a lapse in your subscription."
        : "Your access to Cleardocs has been temporarily suspended due to a lapse in your license."
