...
ONYX_DEFAULT_APPLICATION_NAME = "Cleardocs"
...
# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of Cleardocs.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use Cleardocs as a search engine."
)
